...
('Trimmer'), ('Biscuits & Cookies'), ('Bedding Sheets'), ('Tablets'), ('Plain Shawl');
GO
...
('P002', 'Party Cosplay Player Unknown Battlegrounds Clothes Hallowmas PUBG', 'Men''s Clothing', 2, NULL, 'Suitable for adults and children.'),
...
('P008', 'Non-contact Infrared Forehead Thermometer ABS', 'Kids Health & Skincare', 2, NULL, 'Non-contact Infrared Forehead Thermometer ABS for Adults and Children with LCD Display Digital'),
